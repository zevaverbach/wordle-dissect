const wordleMaker = function(e) {
    ...
    const GameSettings = function(e) {
        r(t, e);var a = h(t);function t() {var e;return s(this, t), n(p(e = a.call(this)), "gameApp", void 0), e.attachShadow({mode: "open"}), e}
        return o(t, [{
    ...
    customElements.define("game-theme-manager", ThemeManager);

    const GameToast = function(e) {
        r(t, e);
        var a = h(t);
    ...
    const CountdownTimer = function(e) {
            r(t, e);
            var a = h(t);
    ...
    window.dataLayer = window.dataLayer || [], Ca("js", new Date);
...
export const wordle = wordleMaker()
